...
> **TRƯỜNG ĐẠI HỌC TRÀ VINH** - **KHOA KỸ THUẬT VÀ CÔNG NGHỆ THÔNG TIN**
...
## [cite_start]I. 🗓️ TƯỜNG TRÌNH ĐỒ ÁN TUẦN 1 (10/11/2025 - 16/11/2025) [cite: 11]
...
## II. [cite_start]💡 NỘI DUNG BÁO CÁO: KIẾN THỨC BLOCKCHAIN CƠ BẢN [cite: 33]
...
* **Cơ chế:** Dữ liệu được lưu trong các block. [cite_start]Mỗi block chứa mã băm (hash) và liên kết với block trước đó để tạo thành chuỗi[cite: 38].
...
* **Mô hình:** Không có máy chủ trung tâm. [cite_start]Mỗi node đều có bản sao blockchain[cite: 58].
...
## III. [cite_start]➡️ KẾ HOẠCH TUẦN TIẾP THEO (24/11/2025 - 30/11/2025) [cite: 63]
